/**
 * Реализауйте алгоритм сортировки пузырьком числового массива, результат после каждой итерации запишите в лог-файл.
 */
...
public class TASK02 {
    ...
    public static int[] babblSort(int arr[]) throws IOException {
        Logger loger = Logger.getLogger(TASK02.class.getName());
